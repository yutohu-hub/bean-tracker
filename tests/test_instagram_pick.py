...
CASES = [
    ...
    ("Dark Matter Coffee",
     link("ridmanscoffee") * 3,
     "", "業種の言葉（coffee）だけの一致では採らない"),
    ("Comete Coffee Roasters",
     link("interpret_coffee") * 3 + link("someshop"),
     "", "他店のアカウントも coffee を含む。それでは見分けられない"),
    ("Dark Matter Coffee",
     link("ridmanscoffee") * 3 + link("darkmattercoffee"),
     "darkmattercoffee", "店名の言葉が入っている方を選ぶ"),
    ("Some Roastery",
     link("randomperson"),
