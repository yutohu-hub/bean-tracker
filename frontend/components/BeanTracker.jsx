...
const ROASTERS = {
  ...
  koppi: { name: "Koppi", city: "Helsingborg", country: "SE", platform: "Shopify", note: "北欧の重鎮", coord: [12.69, 56.05],
  ...
  drop: { name: "Drop Coffee", city: "Stockholm", country: "SE", platform: "Shopify", note: "ストックホルムの実力派", coord: [18.07, 59.33],
  ...
  prolog: { name: "Prolog Coffee", city: "København", country: "DK", platform: "Shopify", note: "コペンハーゲンの精鋭", coord: [12.59, 55.67],
  ...
  flight: { name: "Flight Coffee", city: "Wellington", country: "NZ", platform: "Shopify", note: "産地志向の新鋭", coord: [174.77, -41.29],
    founded: "2011", style: "浅〜中浅煎り・産地志向", ship: "海外発送(1〜2週間)", focus: "エチオピア・コロンビア",
    bio: "ウェリントンの産地志向ロースター。生産者との関係を軸に、明るくクリーンなカップを追求する。" },
  philo: { name: "Philocoffea", city: "船橋 / 千葉", country: "JP", platform: "Shopify", note: "世界王者の設計", coord: [139.98, 35.69],
  ...
  leaves: { name: "Leaves Coffee", city: "東京 / 両国", country: "JP", platform: "Shopify", note: "甘さと香りの追求", coord: [139.79, 35.69],
    founded: "2017", style: "浅煎り・甘さ重視", ship: "国内発送(2〜4日)", focus: "エチオピア・ケニア",
    bio: "東京・両国の焙煎所。甘さと香りに振り切った浅煎りで、焙煎競技でも上位に食い込む石井康雄が率いる。" },
  lightup: { name: "Light Up Coffee", city: "東京 / 吉祥寺", country: "JP", platform: "Shopify", note: "軽やかな明るさ", coord: [139.58, 35.7],
    founded: "2014", style: "浅煎り・クリーン", ship: "国内発送(2〜4日)", focus: "エチオピア・グアテマラ",
    bio: "東京・吉祥寺発。明るくクリーンな浅煎りで、コーヒーの果実感を身近に伝えるロースター。" },
  county: { name: "Coffee County", city: "福岡", country: "JP", platform: "Shopify", note: "九州の名店", coord: [130.4, 33.59],
    founded: "2013", style: "中浅煎り・中米志向", ship: "国内発送(2〜4日)", focus: "エチオピア・グアテマラ",
    bio: "福岡のロースター。中米・アフリカの銘品を軸に、飲み心地の良い明るい焙煎で九州のシーンを牽引する。" },
  nylon: { name: "Nylon Coffee", city: "Singapore", country: "SG", platform: "Shopify", note: "シンガポールの象徴", coord: [103.84, 1.28],
...
const FX_CURRENCIES = ["USD", "NOK", "DKK", "EUR", "AUD", "GBP", "SEK", "CAD", "NZD", "SGD"];
const FX_DEFAULT = { JPY: 1, USD: 150, NOK: 14.5, DKK: 22, EUR: 165, AUD: 100, GBP: 195, SEK: 14, CAD: 108, NZD: 90, SGD: 112 };
const RATES_TO_JPY = { ...FX_DEFAULT };
const CUR_SYMBOL = { JPY: "¥", USD: "$", NOK: "kr ", DKK: "kr ", EUR: "€", AUD: "A$", GBP: "£", SEK: "kr ", CAD: "C$", NZD: "NZ$", SGD: "S$" };
...
const ORIGINS = ["すべて", "エチオピア", "ケニア", "コロンビア", "パナマ", "グアテマラ", "ブラジル", "コスタリカ", "ルワンダ", "エクアドル", "ブレンド"];
