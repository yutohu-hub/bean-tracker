...
const ROASTERS = {
  ...
  supreme: { name: "Supreme Roastworks", city: "Oslo", country: "NO", platform: "Shopify", note: "エチオピアの名店", coord: [10.74, 59.91], url: "srw.no",
...
const BEANS = [
  ...
  { id: 261, r: "supreme", name: "Ethiopia Guji", origin: "エチオピア", process: "Natural", amount: 180, cur: "NOK", per: "250g", status: "now", color: "#F2EFE6", accent: "#8A3B2E", year: "2026" },
  { id: 262, r: "supreme", name: "Colombia Huila", origin: "コロンビア", process: "Washed", amount: 180, cur: "NOK", per: "250g", status: "sold", color: "#3A2E4F", accent: "#D9B44A", year: "2026" },
...
const FX_CURRENCIES = ["USD", "NOK", "DKK", "EUR", "AUD", "GBP", "SEK", "CAD", "NZD", "SGD", "ISK", "KRW", "HKD", "THB"];
const FX_DEFAULT = { JPY: 1, USD: 150, NOK: 14.5, DKK: 22, EUR: 165, AUD: 100, GBP: 195, SEK: 14, CAD: 108, NZD: 90, SGD: 112, ISK: 1.1, KRW: 0.11, HKD: 19, THB: 4.3 };
const RATES_TO_JPY = { ...FX_DEFAULT };
const CUR_SYMBOL = { JPY: "¥", USD: "$", NOK: "kr ", DKK: "kr ", EUR: "€", AUD: "A$", GBP: "£", SEK: "kr ", CAD: "C$", NZD: "NZ$", SGD: "S$", ISK: "kr ", KRW: "₩", HKD: "HK$", THB: "฿" };
...
const TYPE_LABEL = {
  ...
  supreme: { type: "Osloのノルウェー型", desc: "Supreme Roastworksの世界観に惹かれるタイプ。" },
