...
import { RATES_TO_JPY, CUR_SYMBOL, toJPY, fmtPrice, perGrams, fmtLocal, fetchLiveRates } from "./lib/currency";
...
const ORIGINS = ["すべて", "エチオピア", "ケニア", "コロンビア", "パナマ", "グアテマラ", "ブラジル", "メキシコ", "ペルー", "コスタリカ", "ルワンダ", "エクアドル", "インドネシア", "ベトナム", "インド", "中国", "台湾", "タイ", "フィリピン", "ブレンド"];
