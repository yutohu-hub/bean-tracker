  ...
  return (
    <div>
      <div style={{ fontSize: 11, color: GRAY, marginBottom: 10 }}>
        いま買える豆を、味わいの座標で。●をタップするとその豆のページへ移動します（ECサイトでカートに入れられます）。
      </div>
      ...
      <div style={{ position: "relative", width: "100%", aspectRatio: "1 / 1", marginTop: 6,
        ...
        {beans.map((b, i) => {
          ...
          return (
            <button key={b.id} onClick={() => onOpen(b)} title={b.name}
              className="bt-dot"
              style={{
              ...
              <span className="bt-dot-core"
                style={{
                  ...
                  borderRadius: 999, background: f.color, border: `3px solid ${f.color}`,
