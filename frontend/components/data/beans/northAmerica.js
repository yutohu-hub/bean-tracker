...
export const northAmericaBeans = [
  ...
  { id: 811, r: "myriade", name: "Ethiopia Guji Natural", origin: "エチオピア", process: "Natural", amount: 25, cur: "CAD", per: "250g", status: "now", color: "#F2EFE6", accent: "#8A3B2E", year: "2026" },
  { id: 812, r: "myriade", name: "Ethiopia Guji Washed", origin: "エチオピア", process: "Washed", amount: 25, cur: "CAD", per: "250g", status: "sold", color: "#3A2E4F", accent: "#D9B44A", year: "2026" },
  ...
  { id: 1355, r: "metric", name: "エチオピア Honey", origin: "エチオピア", process: "Honey", amount: 19, cur: "USD", per: "12oz", status: "now", color: "#2E2A24", accent: "#C8A96A", year: "2026" },
  { id: 1356, r: "metric", name: "ケニア Anaerobic Natural", origin: "ケニア", process: "Anaerobic Natural", amount: 22, cur: "USD", per: "12oz", status: "now", color: "#EFE9DA", accent: "#2F5233", year: "2026" },
  { id: 1357, r: "metric", name: "コロンビア Washed", origin: "コロンビア", process: "Washed", amount: 21, cur: "USD", per: "12oz", status: "sold", color: "#7C4D8F", accent: "#F2E9DC", year: "2026" },
  { id: 1358, r: "gooddaily", name: "ケニア Washed", origin: "ケニア", process: "Washed", amount: 24, cur: "USD", per: "12oz", status: "now", color: "#B8433A", accent: "#F2E9DC", year: "2026" },
  { id: 1359, r: "gooddaily", name: "コロンビア Washed", origin: "コロンビア", process: "Washed", amount: 20, cur: "USD", per: "12oz", status: "now", color: "#5A2E3A", accent: "#E8C8A0", year: "2026" },
  { id: 1360, r: "gooddaily", name: "ブラジル Natural", origin: "ブラジル", process: "Natural", amount: 25, cur: "USD", per: "12oz", status: "sold", color: "#F4F1E8", accent: "#1A1815", year: "2026" },
  { id: 1361, r: "analog", name: "コロンビア Natural", origin: "コロンビア", process: "Natural", amount: 22, cur: "USD", per: "12oz", status: "now", color: "#3A2E4F", accent: "#D9B44A", year: "2026" },
  { id: 1362, r: "analog", name: "ブラジル Honey", origin: "ブラジル", process: "Honey", amount: 19, cur: "USD", per: "12oz", status: "now", color: "#22303A", accent: "#C8792E", year: "2026" },
  { id: 1363, r: "analog", name: "グアテマラ Anaerobic Washed", origin: "グアテマラ", process: "Anaerobic Washed", amount: 20, cur: "USD", per: "12oz", status: "sold", color: "#6B2D3C", accent: "#EFE9DA", year: "2026" },
  { id: 1403, r: "detourcoffee", name: "コスタリカ Washed", origin: "コスタリカ", process: "Washed", amount: 23, cur: "CAD", per: "340g", status: "now", color: "#B8433A", accent: "#F2E9DC", year: "2026" },
  ...
  { id: 1405, r: "detourcoffee", name: "エチオピア Natural", origin: "エチオピア", process: "Natural", amount: 26, cur: "CAD", per: "340g", status: "sold", color: "#F4F1E8", accent: "#1A1815", year: "2026" },
