...
export const FX_CURRENCIES = ["USD", "NOK", "DKK", "EUR", "AUD", "GBP", "SEK", "CAD", "NZD", "SGD", "ISK", "KRW", "HKD", "THB", "CNY", "IDR", "MYR", "PHP", "INR"];
export const FX_DEFAULT = { JPY: 1, USD: 150, NOK: 14.5, DKK: 22, EUR: 165, AUD: 100, GBP: 195, SEK: 14, CAD: 108, NZD: 90, SGD: 112, ISK: 1.1, KRW: 0.11, HKD: 19, THB: 4.3, CNY: 21, TWD: 4.7, VND: 0.006, IDR: 0.0092, MYR: 33, PHP: 2.6, INR: 1.8 };
export const RATES_TO_JPY = { ...FX_DEFAULT };
export const CUR_SYMBOL = { JPY: "¥", USD: "$", NOK: "kr ", DKK: "kr ", EUR: "€", AUD: "A$", GBP: "£", SEK: "kr ", CAD: "C$", NZD: "NZ$", SGD: "S$", ISK: "kr ", KRW: "₩", HKD: "HK$", THB: "฿", CNY: "CN¥", TWD: "NT$", VND: "₫", IDR: "Rp ", MYR: "RM ", PHP: "₱", INR: "₹" };
